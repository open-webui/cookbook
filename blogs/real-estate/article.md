...
Market investment reflects the same momentum. Industry analysts estimated proptech VC funding reached $16.7 billion in 2025, a 68% year-over-year increase at the time of those estimates, with AI-centered companies growing at roughly twice the rate of the broader sector.
...
The AI can review the copy and surface items that may warrant closer review: the phrase "perfect for young professionals" in the two-bedroom listing (a phrase that may raise familial status questions — it could be read as implying a preference against families with children), and "quiet, established neighborhood" in the home listing (a phrase that has appeared in fair housing cases as coded language, though context and local guidance matter).
